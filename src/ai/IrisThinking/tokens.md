...
The rotation timing (2.4s / 1.8s / 1.4s) is defined as a CSS keyframe `iris-thinking-rotate` in the consumer Tailwind preset; reduced-motion override is `iris-thinking-pulse` (2s ease-in-out opacity 0.4 ↔ 1).
