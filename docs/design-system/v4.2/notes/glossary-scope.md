...
**Owner:** G8 (Growth) (G8) | **Reviewer:** G4 (Design) (G4)
...
| 5 | **Component anatomy nouns** (slot, role, variant, state, tier, density, surface) | ~7 | `spec.md` §7.0 + §22.2 + G4 |
...
- **Reviewers:** G4 (G4 fit), Dr. Amara (G3 — categories 1, 2), G1 (G1 schema CI lint per audit U3.7).
